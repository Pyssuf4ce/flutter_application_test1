...
class _SecurityPageState extends State<SecurityPage> {
  ...
  Future<void> _showEditDialog({required String title, required String currentValue, required String column, bool isPassword = false}) async {
    ...
    return showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text("Change $title", style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], fontWeight: FontWeight.bold)),
        content: TextField(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("SECURITY & ACCOUNT", style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], fontWeight: FontWeight.bold, letterSpacing: 2, fontSize: 16)),
  ...
  Widget _buildSectionTitle(String title) {
    return Padding(
      ...
      child: Text(title, style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], fontSize: 11, fontWeight: FontWeight.w800, color: const Color(0xFF4D58A5), letterSpacing: 1.5)),
    );
  }
