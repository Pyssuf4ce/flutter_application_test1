...
class PostItemPageState extends State<PostItemPage> {
  ...
  void _showSnackBar(String msg, Color color) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(msg, style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], fontWeight: FontWeight.w600)), 
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, _) async {
        ...
        final shouldLeave = await showDialog<bool>(
          ...
          builder: (ctx) => AlertDialog(
            ...
            title: Text('ทิ้งข้อมูลที่กรอกไว้?', style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], fontWeight: FontWeight.bold)),
            content: Text('ถ้าออกจากหน้านี้ ข้อมูลที่กรอกไว้จะหายไป', style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], color: Colors.grey[600])),
            actions: [
              TextButton(onPressed: () => Navigator.pop(ctx, false), child: Text('อยู่ต่อ', style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], color: const Color(0xFF35408B)))),
              TextButton(onPressed: () => Navigator.pop(ctx, true), child: Text('ทิ้ง', style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], color: Colors.red))),
            ],
          ),
        );
      ...
      appBar: AppBar(
        ...
        title: Text(
          "ลงขายสินค้า", 
          style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], fontSize: 16, fontWeight: FontWeight.bold, color: const Color(0xFF191C1D))
        ),
        centerTitle: true,
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(
              "ปล่อยของ", 
              style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], fontSize: 28, fontWeight: FontWeight.w800, color: const Color(0xFF191C1D))
            ),
            const SizedBox(height: 24),
            
            Text("รูปภาพสินค้า", style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], fontSize: 13, fontWeight: FontWeight.bold)),
            ...
            Text("หมวดหมู่", style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], fontSize: 13, fontWeight: FontWeight.bold)),
            ...
            Container(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  ...
                  style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], fontWeight: FontWeight.w600, color: const Color(0xFF191C1D), fontSize: 15),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: _isLoading 
                  ...
                  : Text("ลงขายเลย!", style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], fontSize: 16, fontWeight: FontWeight.bold)),
              ),
            ),
            const SizedBox(height: 24),
          ],
  ...
  Widget _buildInputField(String label, String hint, TextEditingController controller, TextInputType type, {int maxLines = 1, bool isPriceField = false}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(label, style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], fontSize: 13, fontWeight: FontWeight.bold)),
        const SizedBox(height: 8),
        TextField(
          ...
          decoration: InputDecoration(
            ...
            prefixStyle: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], fontWeight: FontWeight.bold, color: const Color(0xFF35408B), fontSize: 16),
          ),
        ),
      ],
    );
