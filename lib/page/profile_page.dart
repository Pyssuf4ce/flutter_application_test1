                  ...
                  children: [
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text("VERIFIED MEMBER", style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], fontSize: 10, fontWeight: FontWeight.bold, color: const Color(0xFFD1DDFA), letterSpacing: 1.5)),
                                    const SizedBox(height: 4),
                                    Text(_username, style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], fontSize: 24, fontWeight: FontWeight.w800, color: Colors.white)),
                                  ],
                                ),
                              ),
                              IconButton(
                    ...
                    Padding(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("SHOPPING", style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], fontSize: 10, fontWeight: FontWeight.bold, letterSpacing: 1.5, color: const Color(0xFF767682))),
                          ...
                          const SizedBox(height: 32),
                          Text("ACCOUNT", style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], fontSize: 10, fontWeight: FontWeight.bold, letterSpacing: 1.5, color: const Color(0xFF767682))),
                          const SizedBox(height: 16),
                          _buildMenuTile(
                          ...
                          SizedBox(
                            ...
                            child: TextButton.icon(
                              ...
                              label: Text("LOG OUT", style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], fontSize: 14, fontWeight: FontWeight.bold, color: const Color(0xFFba1a1a), letterSpacing: 1)),
                            ),
                          ),
    ...
    return GestureDetector(
      ...
      child: Column(
        children: [
          ...
          Text(value, style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], fontSize: 20, fontWeight: FontWeight.w900, color: const Color(0xFF191C1D))),
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(title, style: TextStyle(fontFamily: 'Manrope', fontFamilyFallback: ['Noto Sans Thai'], fontWeight: FontWeight.bold, fontSize: 16, color: const Color(0xFF191C1D))),
                    const SizedBox(height: 4),
